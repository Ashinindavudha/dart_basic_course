...
void main(List<String> args) {
  ...
  */
  ...
  // * equality
  /* you can test for equality using the equality operator, which is denoted by == */
  const isYesNo = (yes == no);
  print('Is yes equal to no? $isYesNo');

  // * Inequality
  // you can test for inequality using the inequality operator, which is denoted by !=
