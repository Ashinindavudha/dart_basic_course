...
void main() {
  ...
  print(enterName('ashin'));
  print(enterName('Ashin', 'Indavudha'));

  enterProfileDetails('Ashin');
  enterProfileDetails('Indavudha', 'Developer');

  editProfile(newName: 'Ashin', newPassword: '123abc');

  userDetails('Ashinindavudha', position: 'Software Enginner');
}
